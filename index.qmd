...
2. Obtain information: The application will process the data within the AOI and display the key indicators in the results panel, including Flood Extent Areas, Damaged Built-Up Areas, Damaged Crop Land Areas, Estimated Affected Population. 

3. Visualization: The map will display visual overlays within the AOI that include Built-Up Areas, Crop Lands, Building Footprints, and Flood Extents. This setup clearly identifies flood-impacted regions and aids in understanding affected areas.
